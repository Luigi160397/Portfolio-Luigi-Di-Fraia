...
const ProjectCard = ({ id, name, description, image, repo, index, active, handleClick }) => {
  return (
    <motion.div
  ...
  return (
    <div className="-mt-[6rem]">
      <motion.div variants={textVariant()}>
        ...
        <h2 className={`${styles.sectionHeadTextLight}`}>Progetti.</h2>
      </motion.div>

      <div className="w-full flex">
        <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-4 text-taupe text-[18px] max-w-3xl leading-[30px]">
          Questi sono alcuni dei miei progetti di cui vado più fiero.
        </motion.p>
      </div>
