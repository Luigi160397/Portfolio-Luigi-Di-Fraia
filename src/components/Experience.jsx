  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} sm:pl-16 pl-[2rem]`}>Cosa ho fatto</p>
        <h2 className={`${styles.sectionHeadText} sm:pl-16 pl-[2rem]`}>Formazione</h2>
      </motion.div>
        ...
        <VerticalTimeline className="vertical-timeline-custom-line">
          ...
          >
            <button
              ...
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/1Un0iDLodizPYhPIPJ0PPz9-9NnXPn-QR/view?usp=sharing", //paste the link to your resume here
                  "_blank"
                )
              }
              onMouseOver={() => {
